...
Where we have used the formula $J(R,G) = \begin{smallmatrix}\frac{\partial{F}}{\partial{R}} & \frac{\partial{F}}{\partial{G}}\\ \frac{\partial{E}}{\partial{R}} & \frac{\partial{E}}{\partial{G}}\end{smallmatrix} $ Where $F(R,G) = \frac{\mathrm{d}R}{\mathrm{d}t}$ and $E(R,G) = \frac{\mathrm{d}G}{\mathrm{d}t}$

Calculating the Jacobian matrix of the system:
